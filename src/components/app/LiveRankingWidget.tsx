  ...
  return (
    <div className="bg-gradient-to-br from-violet-50 to-primary/5 rounded-2xl border border-violet-100 overflow-hidden">
      ...
      <div className="px-4 pb-4">
        ...
        <Link
          href="/practice"
          className="flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-gradient-to-r from-violet-600 to-primary text-white font-semibold text-sm transition-transform active:scale-[0.98]"
        >
