...
[시대적 배경 사고]
Q5. 이 곡이 작곡된 시기, 해당 악기(${instrument ?? "piano"}) 음악계에서 구체적으로 무슨 일이 있었는가?
    (유행한 장르, 악기/연주 기술 혁신, 청중의 취향 변화 등)
...
각 섹션의 guide는 3-6문장으로, 섹션 크기에 비례하여 아래 4가지를 다루십시오 (짧은 소품은 3문장, 긴 전개부는 5-6문장):
...
- youtube_url: 빈 문자열("")로 두십시오. 앱에서 자동으로 검색 링크를 생성합니다. 잘못된 URL을 만들지 마십시오.`;
}
