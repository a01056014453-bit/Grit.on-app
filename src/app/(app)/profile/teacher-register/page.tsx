...
export default function TeacherRegisterPage() {
  ...
  // 카카오 인증 (비활성화 — 자동 통과)
  const [kakaoVerified] = useState(true);
  const [kakaoId] = useState("auto-verified");
  const [isKakaoLoading] = useState(false);
  ...
  // 카카오 인증 비활성화 — 관련 코드 제거됨
  void isKakaoLoading; // unused 경고 방지
